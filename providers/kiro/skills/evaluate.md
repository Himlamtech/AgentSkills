---
inclusion: manual
description: "Design ground truth datasets, run evals, inspect traces/logs, triage bugs, and patch failing agent/runtime code. Use when building or updating eval sets, tracing live runs, diagnosing false passes/fails, adding logging, or fixing code from eval evidence."
---
