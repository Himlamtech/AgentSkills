---
inclusion: manual
description: "Write implementation-ready engineering docs from a proposal, feature request, issue, or architecture intent -- grounded in the current repo state. Use before coding starts. Produces a living doc that separates current state from target state with concrete file impact and test specs."
---
