---
inclusion: manual
description: "Review code for logic regressions, contract drift, redundant logic, over-engineering, dependency risk, missing tests, and insecure patterns. Findings-first, severity-ordered, evidence-required."
---
