---
inclusion: auto
description: "Prevent agent from generating placeholder code, stubs, mocks, fake implementations, or workaround functions that bypass real logic. This is the primary anti-hallucination and anti-reward-hacking guardrail."
---
