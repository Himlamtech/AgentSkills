---
name: evaluate
description: "Design ground truth datasets, run evals, inspect traces/logs, triage bugs, and patch failing code. Use when building eval sets, tracing live runs, diagnosing false passes/fails, or fixing code from eval evidence. Triggers on: \"evaluate this\", \"run eval\", \"triage this bug\", \"inspect trace\", \"build ground truth\"."
---
