---
name: implement
description: "Implement approved features, fixes, or refactors from a proposal, issue, or Plan output -- grounded in the current repo state. Delivers verified code with smallest complete diff. Triggers on: \"implement this\", \"code this up\", \"build it\", \"make the changes\", \"continue\"."
---
