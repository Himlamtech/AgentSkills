---
name: research
description: "Survey and evaluate new models, methods, product features, vendor offerings, and current news against current repo and product context. Use for source-backed comparisons, adoption decisions, competitive scans, build-vs-buy evaluation. Triggers on: \"research this\", \"investigate\", \"compare options\", \"latest on\", \"should we adopt\", \"assess fit\"."
---
