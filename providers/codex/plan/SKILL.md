---
name: plan
description: "Write implementation-ready engineering docs from a proposal, feature request, issue, or architecture intent -- grounded in the current repo state. Produces a living doc separating current state from target state with concrete file impact and test specs. Triggers on: \"plan this\", \"write a proposal\", \"design doc\", \"before we implement\", \"document this feature\"."
---
